...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.table_videos.setRowCount(15)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.table_videos.setItem(0, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_videos.setItem(0, 1, item)
        item = QtWidgets.QTableWidgetItem()
        item.setFlags(QtCore.Qt.ItemIsSelectable|QtCore.Qt.ItemIsEditable|QtCore.Qt.ItemIsDragEnabled|QtCore.Qt.ItemIsUserCheckable|QtCore.Qt.ItemIsEnabled)
        self.table_videos.setItem(0, 2, item)
        item = QtWidgets.QTableWidgetItem()
        ...
        self.table_videos.setItem(3, 2, item)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.loop.setText(_translate("MainWindow", "Inspect"))
        self.loadnew.setText(_translate("MainWindow", "Load New"))
        self.override.setText(_translate("MainWindow", "Next"))
        ...
        __sortingEnabled = self.table_videos.isSortingEnabled()
        self.table_videos.setSortingEnabled(False)
        item = self.table_videos.item(0, 0)
        item.setToolTip(_translate("MainWindow", "Video file to play."))
        item = self.table_videos.item(0, 1)
        item.setToolTip(_translate("MainWindow", "Absolute time to play video,"))
        item = self.table_videos.item(0, 2)
        item.setToolTip(_translate("MainWindow", "Time relative to start to play video"))
        self.table_videos.setSortingEnabled(__sortingEnabled)
